...
/**
 * Class m191214_152458_create_stud_tables
 */
class m191214_152458_create_stud_tables extends Migration
{
    /**
     * {@inheritdoc}
     */
    public function safeUp()
    {
        $this->createTable('{{%users}}', [
            ...
            'login' => $this->string(50)->unique()->notNull()->comment('Логин пользователя'),
    ...
    {
        echo "m191214_152458_create_stud_tables cannot be reverted.\n";
